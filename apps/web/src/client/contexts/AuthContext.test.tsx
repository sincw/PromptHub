...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <button data-testid="btn-login" onClick={() => void login({ username: 'test', password: 'pw' })}>Login</button>
      <button data-testid="btn-register" onClick={() => void register({ username: 'new', password: 'pw' })}>Register</button>
